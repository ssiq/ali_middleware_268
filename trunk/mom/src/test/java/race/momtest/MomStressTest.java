...
import com.alibaba.middleware.race.mom.util.Count;
...
public class MomStressTest {
	...
	private static void testBasic() {
		...
		try {
			final Count count=new Count("delay time");
...
/*					if (delay>1000) {
			...
			producer.start();
			final AtomicLong lastSendTime=new AtomicLong(System.currentTimeMillis());
...
//								long t = lastSendTime.get();
//								lastSendTime.set(System.currentTimeMillis());
//								t = lastSendTime.get() - t;
//								if (t != 0) {
//									System.out.println("off last send:" + t);
//								} else {
