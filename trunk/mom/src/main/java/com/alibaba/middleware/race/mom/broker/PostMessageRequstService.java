...
//                    sem.down();
        ...
        public Pair<Runnable,Runnable> snapshot()
        {
            ...
            final int number=no.incrementAndGet();
...
//                    System.out.println("cores:"+cores);
                    for(int i=0;i<cores;++i)
                    {
                        ...
                        executorService.submit(new Runnable() {
                            @Override
                            public void run() {
//                                System.out.println(""+number+" "+ finalI +"begin");
...
//                                System.out.println(""+number+" "+ finalI +"end");
                            }
                        });
                    }
                }
...
//                    Sem sem=new Sem();
                    ...
                    {
//                        System.out.println("delay "+number+" one: "+doneNumber.get()+" size:"+size +" cando:"+canDo.get());
                        PostMessage postMessage=afterQueue.poll();
                        while (postMessage!=null)
                        {
                            executorService.submit(getPostRunabble(postMessage,null));
