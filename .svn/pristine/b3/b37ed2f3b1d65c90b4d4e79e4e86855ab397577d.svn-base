...
public class ConsumerBuilder {
    ...
    /**
     * set the method {@code getString} of {@link demo.service.RaceTestService} asynchronous
    ...
    /**
     * set the method {@code getDO} of {@link demo.service.RaceTestService} asynchronous
